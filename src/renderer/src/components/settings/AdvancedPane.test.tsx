...
describe('AdvancedPane', () => {
  it('renders HTTP/1.1 compatibility as a neutral advanced setting', () => {
    ...
    expect(markup).toContain('Settings Portability')
    ...
    expect(getAdvancedSearchEntry().settingsPortability.keywords).toContain('sync')
    expect(getAdvancedSearchEntry().settingsPortability.keywords).toContain('keybindings')
  })
})
