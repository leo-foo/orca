 ...
 *  that differ, whether shortcuts come along, and any skipped keys. Shared by
 *  the one-time import modal and the sync setup modal. */
export function PortableSettingsChangeSummary({
  ...
  const hasChanges = changedKeys.length > 0 || preview.includesKeybindings
